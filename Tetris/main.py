...
def render(field, Tetramino, screen):
    screen.fill((0,0,0))
    for i in range(9):
    ...
    for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    field= Tetramino.Copy(static, 17, 10,2, 0)
                    for i in range(4):
                        if Tetramino.fig[Tetramino.Rotation][i][1]-1 <0 or field[Tetramino.fig[Tetramino.Rotation][i][0]][Tetramino.fig[Tetramino.Rotation][i][1]-1][0] == "[]" or Tetramino.fig[Tetramino.Rotation][i][1]-1 <0:
                            break
                    else:
                        for j in range(4):
                            for i in range(4):
                    ...
                    field= Tetramino.Copy(static, 17, 10,2, 0)
                    for i in range(4):
                        if Tetramino.fig[Tetramino.Rotation][i][1]+1 >9 or field[Tetramino.fig[Tetramino.Rotation][i][0]][Tetramino.fig[Tetramino.Rotation][i][1]+1][0] == "[]" or Tetramino.fig[Tetramino.Rotation][i][1]+1 >9:
                            break
                    else:
                        for j in range(4):
                            for i in range(4):
                    ...
                    field= Tetramino.Copy(static, 17, 10,2, 0)
                    for i in range(4):
                        if Tetramino.fig[Tetramino.Rotation][i][1]-1 <0 or Tetramino.fig[Tetramino.Rotation][i][1]+1 >9 or field[Tetramino.fig[(Tetramino.Rotation+1)%4][i][0]][Tetramino.fig[(Tetramino.Rotation+1)%4][i][1]+1][0] == "[]":
                            break
                    else:
        ...
        while True:
            ...
            if InAir == False:
                if Tetramino.fig[Tetramino.Rotation][0][0]<0:
                    Gameover = True
                field = clear(field)
                static= Tetramino.Copy(field, 17, 10,2, 0)
                break
